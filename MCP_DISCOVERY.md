...
> **This table is the original plan, kept as the record. Five tools shipped
> beyond it** — `get_playoff_odds` (phase 2a, the first "deferred" item below),
> `get_player_news` (phase 2c), and `find_trade_targets`, `research_rookies`
> and `scout_managers` (2026-09-22, all three deferred below). CLAUDE.md's
> **The MCP Server** section is the live truth for all eleven; this section is what was specified on
> 2026-09-19.
>
