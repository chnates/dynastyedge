...
**The PWA saga (why that class is special), as of 2026-07-05:** `cfd9ad0`
replaced the `black-translucent` status bar with a theme-color approach; it
