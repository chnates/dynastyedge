...
export default function LineupEfficiency() {
  ...
  if (loading) {
    return (
      <section>
        <SectionHeader label="Season Review" />
  ...
  return (
    <section>
      <SectionHeader label="Season Review" count={`${rows.length} wks`} />

      <div className="rounded-xl bg-bg-card dark:bg-bg-card border border-border-default dark:border-border-default px-4 py-3 mb-2">
